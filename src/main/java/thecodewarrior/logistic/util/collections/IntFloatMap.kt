...
class IntFloatMap(size: Int,
     ...
     */
    private fun getReadIndex(key: Int): Int {
     ...
     */
    private fun getPutIndex(key: Int): Int {
    ...
    private fun getStartIndex(key: Int): Int {
        return Tools.phiMix(key) and m_mask
    }
